...
| Detect skill | `skills/pandamux-detect/SKILL.md` | Detects PandaMUX Everywhere availability and sets fallback mode ([README.md:120-121](https://github.com/BoardPandas/Pandamux/blob/0ab9e6463a9017a7b8ea98f10b3f847507658ac4/resources/pandamux-orchestrator/README.md#L120-L121)) |
...
The plugin degrades gracefully when PandaMUX Everywhere is not running, falling back to Claude Code's native Agent tool instead of visible panes ([README.md:68-82](https://github.com/BoardPandas/Pandamux/blob/0ab9e6463a9017a7b8ea98f10b3f847507658ac4/resources/pandamux-orchestrator/README.md#L68-L82)):

| Capability | With PandaMUX Everywhere | Without (degraded) |
|---|---|---|
