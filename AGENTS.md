# PandaMUX Everywhere — Agent Guide

PandaMUX Everywhere is a native Windows terminal multiplexer for AI agents, built as a Rust workspace (Iced + alacritty_terminal + portable-pty + russh). The Electron/TypeScript prototype this repo started from has been removed.
