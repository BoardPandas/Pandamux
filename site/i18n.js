/**
 * PandaMUX Everywhere i18n — 22 languages, browser detection, RTL support
 */
const LANGS = {
  en: "English",
  fr: "Français",
...
const T = {
  ...
  en: {
    ...
    "f1.desc":
      'PandaMUX Everywhere observes Claude Code without modifying its behavior. A CDP proxy on <code>localhost:9222</code> lets the built-in browser show every action in real time. Auto-configured hooks report agent and tool activity to the sidebar. Zero configuration.',
    ...
    "faq1.q": "What is the relationship between PandaMUX Everywhere and cmux?",
    "faq1.a":
      'PandaMUX Everywhere is a Windows fork of <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux is a native macOS app (Swift + AppKit + Ghostty). PandaMUX Everywhere reproduces the same experience on Windows using Electron + xterm.js + ConPTY. The CLI/pipe protocol is compatible between the two.',
    ...
    "faq3.a":
      "PandaMUX Everywhere is optimized for Claude Code with automatic passive integration (hooks, CDP proxy, CLAUDE.md). Any command-line agent or program can be used in PandaMUX Everywhere terminals — Codex, Gemini CLI, Aider, OpenCode, or any script.",
    ...
    "faq5.a":
      "Windows Terminal is an excellent terminal emulator, but it has no notification system, no agent activity visibility, no built-in browser, and no live metadata (git branch, ports, PR) in tabs. PandaMUX Everywhere is specifically designed to supervise AI agents.",
    "faq6.q": "Is it free?",
    "faq6.a":
      'Yes. PandaMUX Everywhere is open-source under the MIT license. Free download on <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
    ...
    "footer.copyright": "© 2026 PandaMUX Everywhere",
  ...
  fr: {
    ...
    "f1.desc":
      'PandaMUX Everywhere observe Claude Code sans modifier son comportement. Un proxy CDP sur <code>localhost:9222</code> permet au navigateur intégré de montrer chaque action en temps réel. Les hooks auto-configurés rapportent l\'activité des agents et outils dans la barre latérale. Zéro configuration.',
    ...
    "faq1.q": "Quelle est la relation entre PandaMUX Everywhere et cmux ?",
    "faq1.a":
      'PandaMUX Everywhere est un fork Windows de <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux est une application macOS native (Swift + AppKit + Ghostty). PandaMUX Everywhere reproduit la même expérience sur Windows en utilisant Electron + xterm.js + ConPTY. Le protocole CLI/pipe est compatible entre les deux.',
    ...
    "faq3.a":
      "PandaMUX Everywhere est optimisé pour Claude Code avec intégration passive automatique (hooks, CDP proxy, CLAUDE.md). Tout agent ou programme en ligne de commande peut être utilisé dans les terminaux PandaMUX Everywhere — Codex, Gemini CLI, Aider, OpenCode, ou n'importe quel script.",
    ...
    "faq5.a":
      "Windows Terminal est un excellent émulateur de terminal, mais il n'a pas de système de notification, pas de visibilité sur l'activité des agents, pas de navigateur intégré, et pas de métadonnées live (branche git, ports, PR) dans les onglets. PandaMUX Everywhere est conçu spécifiquement pour superviser des agents IA.",
    "faq6.q": "C'est gratuit ?",
    "faq6.a":
      'Oui. PandaMUX Everywhere est open-source sous licence MIT. Téléchargement gratuit sur <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  es: {
    ...
    "f1.desc":
      'PandaMUX Everywhere observa Claude Code sin modificar su comportamiento. Un proxy CDP en <code>localhost:9222</code> permite al navegador integrado mostrar cada acción en tiempo real. Los hooks autoconfigurados reportan la actividad de agentes y herramientas en la barra lateral. Cero configuración.',
    ...
    "faq1.q": "¿Cuál es la relación entre PandaMUX Everywhere y cmux?",
    "faq1.a":
      'PandaMUX Everywhere es un fork de Windows de <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux es una app nativa de macOS (Swift + AppKit + Ghostty). PandaMUX Everywhere reproduce la misma experiencia en Windows usando Electron + xterm.js + ConPTY. El protocolo CLI/pipe es compatible entre ambos.',
    ...
    "faq3.a":
      "PandaMUX Everywhere está optimizado para Claude Code con integración pasiva automática (hooks, proxy CDP, CLAUDE.md). Cualquier agente o programa de línea de comandos puede usarse en los terminales PandaMUX Everywhere — Codex, Gemini CLI, Aider, OpenCode o cualquier script.",
    ...
    "faq5.a":
      "Windows Terminal es un excelente emulador de terminal, pero no tiene sistema de notificaciones, ni visibilidad de actividad de agentes, ni navegador integrado, ni metadatos en vivo (rama git, puertos, PR) en las pestañas. PandaMUX Everywhere está diseñado específicamente para supervisar agentes IA.",
    "faq6.q": "¿Es gratis?",
    "faq6.a":
      'Sí. PandaMUX Everywhere es open-source bajo licencia MIT. Descarga gratuita en <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  de: {
    ...
    "f1.name": "Passive Claude Code Integration",
    "f1.desc":
      'PandaMUX Everywhere beobachtet Claude Code ohne sein Verhalten zu ändern. Ein CDP-Proxy auf <code>localhost:9222</code> lässt den integrierten Browser jede Aktion in Echtzeit anzeigen. Automatisch konfigurierte Hooks melden Agenten- und Tool-Aktivität in der Seitenleiste. Null Konfiguration.',
    ...
    "faq1.q": "Was ist die Beziehung zwischen PandaMUX Everywhere und cmux?",
    "faq1.a":
      'PandaMUX Everywhere ist ein Windows-Fork von <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux ist eine native macOS-App (Swift + AppKit + Ghostty). PandaMUX Everywhere reproduziert die gleiche Erfahrung unter Windows mit Electron + xterm.js + ConPTY. Das CLI/Pipe-Protokoll ist zwischen beiden kompatibel.',
    ...
    "faq3.a":
      "PandaMUX Everywhere ist für Claude Code mit automatischer passiver Integration optimiert (Hooks, CDP-Proxy, CLAUDE.md). Jeder Kommandozeilen-Agent oder jedes Programm kann in PandaMUX Everywhere-Terminals verwendet werden — Codex, Gemini CLI, Aider, OpenCode oder jedes Skript.",
    ...
    "faq5.a":
      "Windows Terminal ist ein hervorragender Terminal-Emulator, hat aber kein Benachrichtigungssystem, keine Agenten-Aktivitätssichtbarkeit, keinen integrierten Browser und keine Live-Metadaten (Git-Branch, Ports, PR) in den Tabs. PandaMUX Everywhere ist speziell für die Überwachung von KI-Agenten konzipiert.",
    "faq6.q": "Ist es kostenlos?",
    "faq6.a":
      'Ja. PandaMUX Everywhere ist Open-Source unter der MIT-Lizenz. Kostenloser Download auf <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  pt: {
    ...
    "f1.desc": 'PandaMUX Everywhere observa o Claude Code sem modificar seu comportamento. Um proxy CDP em <code>localhost:9222</code> permite ao navegador integrado mostrar cada ação em tempo real. Hooks autoconfigurados reportam atividade de agentes e ferramentas na barra lateral. Zero configuração.',
    "f2.name": "Navegador integrado",
    ...
    "f8.name": "Scriptável",
    "f8.desc": 'CLI e API named pipe (<code>\\\\.\\pipe\\pandamux</code>) para automação e scripting. Protocolo JSON-RPC v2 compatível com cmux.',
    ...
    "faq1.q": "Qual é a relação entre PandaMUX Everywhere e cmux?",
    "faq1.a": 'PandaMUX Everywhere é um fork Windows de <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux é um app nativo macOS (Swift + AppKit + Ghostty). PandaMUX Everywhere reproduz a mesma experiência no Windows usando Electron + xterm.js + ConPTY. O protocolo CLI/pipe é compatível entre os dois.',
    ...
    "faq3.a": "PandaMUX Everywhere é otimizado para Claude Code com integração passiva automática (hooks, proxy CDP, CLAUDE.md). Qualquer agente ou programa de linha de comando pode ser usado nos terminais PandaMUX Everywhere — Codex, Gemini CLI, Aider, OpenCode ou qualquer script.",
    ...
    "faq5.a": "Windows Terminal é um excelente emulador de terminal, mas não tem sistema de notificações, visibilidade de atividade de agentes, navegador integrado ou metadados em tempo real (branch git, portas, PR) nas abas. PandaMUX Everywhere é projetado especificamente para supervisionar agentes IA.",
    "faq6.q": "É grátis?",
    "faq6.a": 'Sim. PandaMUX Everywhere é open-source sob licença MIT. Download gratuito em <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  it: {
    ...
    "f1.desc": 'PandaMUX Everywhere osserva Claude Code senza modificare il suo comportamento. Un proxy CDP su <code>localhost:9222</code> permette al browser integrato di mostrare ogni azione in tempo reale. Gli hook autoconfigurati riportano l\'attività di agenti e strumenti nella barra laterale. Zero configurazione.',
    ...
    "f8.name": "Scriptabile",
    "f8.desc": 'CLI e API named pipe (<code>\\\\.\\pipe\\pandamux</code>) per automazione e scripting. Protocollo JSON-RPC v2 compatibile con cmux.',
    "f9.name": "Nativo Windows",
    ...
    "faq1.q": "Qual è la relazione tra PandaMUX Everywhere e cmux?",
    "faq1.a": 'PandaMUX Everywhere è un fork Windows di <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux è un\'app nativa macOS (Swift + AppKit + Ghostty). PandaMUX Everywhere riproduce la stessa esperienza su Windows usando Electron + xterm.js + ConPTY. Il protocollo CLI/pipe è compatibile tra i due.',
    ...
    "faq3.a": "PandaMUX Everywhere è ottimizzato per Claude Code con integrazione passiva automatica (hook, proxy CDP, CLAUDE.md). Qualsiasi agente o programma da riga di comando può essere usato nei terminali PandaMUX Everywhere — Codex, Gemini CLI, Aider, OpenCode o qualsiasi script.",
    ...
    "faq5.a": "Windows Terminal è un eccellente emulatore di terminale, ma non ha un sistema di notifiche, visibilità sull'attività degli agenti, browser integrato o metadati live (branch git, porte, PR) nei tab. PandaMUX Everywhere è progettato specificamente per supervisionare agenti IA.",
    "faq6.q": "È gratuito?",
    "faq6.a": 'Sì. PandaMUX Everywhere è open-source sotto licenza MIT. Download gratuito su <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  nl: {
    ...
    "f1.name": "Passieve Claude Code integratie", "f1.desc": 'PandaMUX Everywhere observeert Claude Code zonder het gedrag te wijzigen. Een CDP-proxy op <code>localhost:9222</code> laat de ingebouwde browser elke actie in realtime tonen. Automatisch geconfigureerde hooks rapporteren agent- en tool-activiteit in de zijbalk. Nul configuratie.',
    ...
    "f8.name": "Scriptbaar", "f8.desc": 'CLI en named pipe API (<code>\\\\.\\pipe\\pandamux</code>) voor automatisering en scripting. JSON-RPC v2 protocol compatibel met cmux.',
    ...
    "faq1.q": "Wat is de relatie tussen PandaMUX Everywhere en cmux?", "faq1.a": 'PandaMUX Everywhere is een Windows-fork van <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux is een native macOS-app (Swift + AppKit + Ghostty). PandaMUX Everywhere reproduceert dezelfde ervaring op Windows met Electron + xterm.js + ConPTY.',
    ...
    "faq3.q": "Welke agenten zijn compatibel?", "faq3.a": "PandaMUX Everywhere is geoptimaliseerd voor Claude Code. Elke commandoregel-agent kan worden gebruikt — Codex, Gemini CLI, Aider, OpenCode of elk script.",
    ...
    "faq5.q": "Hoe verschilt het van Windows Terminal?", "faq5.a": "Windows Terminal heeft geen meldingssysteem, geen agentactiviteitsweergave, geen ingebouwde browser en geen live-metadata in tabbladen. PandaMUX Everywhere is specifiek ontworpen voor het toezicht op AI-agenten.",
    "faq6.q": "Is het gratis?", "faq6.a": 'Ja. PandaMUX Everywhere is open-source onder MIT. Gratis download op <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
    ...
    "footer.legal": "Juridisch", "footer.license": "MIT-licentie", "footer.social": "Social", "footer.copyright": "© 2026 PandaMUX Everywhere", "footer.fork": "Windows-fork van", "plugin.badge": "Claude Code Plugin", "plugin.desc": "Start meerdere Claude Code-agenten parallel vanuit één commando. De plugin analyseert je codebase, splitst de taak in onafhankelijke deeltaken en verdeelt ze in golven met afhankelijkheidsbeheer, geïsoleerde bestandszones en automatische review aan het einde van elke cyclus.", "plugin.install_label": "Installatie", "plugin.view_github": "Bekijk op GitHub", "plugin.docs": "Documentatie",
  },
  ...
  pl: {
    ...
    "f1.name": "Pasywna integracja z Claude Code", "f1.desc": 'PandaMUX Everywhere obserwuje Claude Code bez modyfikowania jego zachowania. Proxy CDP na <code>localhost:9222</code> pozwala wbudowanej przeglądarce pokazywać każdą akcję w czasie rzeczywistym. Zero konfiguracji.',
    ...
    "f8.name": "Skryptowalny", "f8.desc": 'CLI i API named pipe (<code>\\\\.\\pipe\\pandamux</code>) do automatyzacji i skryptów. Protokół JSON-RPC v2 kompatybilny z cmux.',
    ...
    "faq1.q": "Jaka jest relacja między PandaMUX Everywhere a cmux?", "faq1.a": 'PandaMUX Everywhere to fork Windows projektu <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux to natywna aplikacja macOS. PandaMUX Everywhere odtwarza to samo doświadczenie na Windows.',
    ...
    "faq3.q": "Jakie agenty są kompatybilne?", "faq3.a": "PandaMUX Everywhere jest zoptymalizowany dla Claude Code. Każdy agent wiersza poleceń może być używany — Codex, Gemini CLI, Aider, OpenCode lub dowolny skrypt.",
    ...
    "faq5.q": "Czym się różni od Windows Terminal?", "faq5.a": "Windows Terminal nie ma systemu powiadomień, widoczności agentów, wbudowanej przeglądarki ani metadanych na żywo. PandaMUX Everywhere jest zaprojektowany do nadzorowania agentów AI.",
    "faq6.q": "Czy jest darmowy?", "faq6.a": 'Tak. PandaMUX Everywhere jest open-source na licencji MIT. Darmowe pobieranie na <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
    ...
    "footer.legal": "Prawne", "footer.license": "Licencja MIT", "footer.social": "Social", "footer.copyright": "© 2026 PandaMUX Everywhere", "footer.fork": "Fork Windows projektu", "plugin.badge": "Plugin Claude Code", "plugin.desc": "Uruchom wielu agentów Claude Code równolegle jednym poleceniem. Plugin analizuje bazę kodu, dzieli zadanie na niezależne podzadania i rozdziela je falami z zarządzaniem zależnościami, izolowanymi strefami plików i automatycznym przeglądem na końcu każdego cyklu.", "plugin.install_label": "Instalacja", "plugin.view_github": "Zobacz na GitHub", "plugin.docs": "Dokumentacja",
  },
  ...
  tr: {
    ...
    "f1.name": "Pasif Claude Code entegrasyonu", "f1.desc": 'PandaMUX Everywhere, Claude Code\'u davranışını değiştirmeden gözlemler. <code>localhost:9222</code> üzerindeki CDP proxy\'si her eylemi gerçek zamanlı gösterir. Sıfır yapılandırma.',
    ...
    "f8.name": "Scriptlenebilir", "f8.desc": 'CLI ve named pipe API (<code>\\\\.\\pipe\\pandamux</code>) otomasyon ve scripting için. cmux ile uyumlu JSON-RPC v2 protokolü.',
    ...
    "faq1.q": "PandaMUX Everywhere ve cmux arasındaki ilişki nedir?", "faq1.a": 'PandaMUX Everywhere, <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>\'un Windows fork\'udur. cmux yerel macOS uygulamasıdır. PandaMUX Everywhere aynı deneyimi Windows\'ta Electron + xterm.js + ConPTY kullanarak yeniden üretir.',
    ...
    "faq3.q": "Hangi ajanlar uyumlu?", "faq3.a": "PandaMUX Everywhere, Claude Code için optimize edilmiştir. Herhangi bir komut satırı ajanı kullanılabilir — Codex, Gemini CLI, Aider, OpenCode veya herhangi bir script.",
    ...
    "faq5.q": "Windows Terminal'den farkı nedir?", "faq5.a": "Windows Terminal\'de bildirim sistemi, ajan aktivite görünürlüğü, yerleşik tarayıcı ve canlı metadata yoktur. PandaMUX Everywhere özellikle AI ajanlarını denetlemek için tasarlanmıştır.",
    "faq6.q": "Ücretsiz mi?", "faq6.a": 'Evet. PandaMUX Everywhere MIT lisansı altında açık kaynaklıdır. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>\'tan ücretsiz indirin.',
  ...
  ru: {
    ...
    "f1.name": "Пассивная интеграция с Claude Code", "f1.desc": 'PandaMUX Everywhere наблюдает за Claude Code не изменяя его поведение. CDP-прокси на <code>localhost:9222</code> позволяет встроенному браузеру показывать каждое действие в реальном времени. Нулевая настройка.',
    ...
    "f8.name": "Скриптуемый", "f8.desc": 'CLI и API именованного канала (<code>\\\\.\\pipe\\pandamux</code>) для автоматизации и скриптов. Протокол JSON-RPC v2 совместимый с cmux.',
    ...
    "faq1.q": "Какая связь между PandaMUX Everywhere и cmux?", "faq1.a": 'PandaMUX Everywhere — это форк <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> для Windows. cmux — нативное приложение macOS. PandaMUX Everywhere воспроизводит тот же опыт на Windows используя Electron + xterm.js + ConPTY.',
    ...
    "faq3.q": "Какие агенты совместимы?", "faq3.a": "PandaMUX Everywhere оптимизирован для Claude Code. Любой агент командной строки может использоваться — Codex, Gemini CLI, Aider, OpenCode или любой скрипт.",
    ...
    "faq5.q": "Чем отличается от Windows Terminal?", "faq5.a": "Windows Terminal не имеет системы уведомлений, видимости активности агентов, встроенного браузера и метаданных в реальном времени. PandaMUX Everywhere разработан специально для наблюдения за ИИ-агентами.",
    "faq6.q": "Это бесплатно?", "faq6.a": 'Да. PandaMUX Everywhere — open-source под лицензией MIT. Бесплатная загрузка на <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  uk: {
    ...
    "f1.name": "Пасивна інтеграція з Claude Code", "f1.desc": 'PandaMUX Everywhere спостерігає за Claude Code не змінюючи його поведінку. CDP-проксі на <code>localhost:9222</code> дозволяє вбудованому браузеру показувати кожну дію в реальному часі.',
    ...
    "f8.name": "Скриптовий", "f8.desc": 'CLI та API іменованого каналу (<code>\\\\.\\pipe\\pandamux</code>) для автоматизації.',
    ...
    "faq1.q": "Який зв'язок між PandaMUX Everywhere і cmux?", "faq1.a": 'PandaMUX Everywhere — це форк <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> для Windows.',
    ...
    "faq3.q": "Які агенти сумісні?", "faq3.a": "PandaMUX Everywhere оптимізований для Claude Code. Будь-який агент командного рядка може використовуватися.",
    ...
    "faq5.q": "Чим відрізняється від Windows Terminal?", "faq5.a": "PandaMUX Everywhere розроблений спеціально для спостереження за ШІ-агентами з сповіщеннями та вбудованим браузером.",
    "faq6.q": "Це безкоштовно?", "faq6.a": 'Так. PandaMUX Everywhere — open-source під ліцензією MIT. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  ar: {
    ...
    "f1.name": "تكامل سلبي مع Claude Code", "f1.desc": 'يراقب PandaMUX Everywhere Claude Code دون تغيير سلوكه. بروكسي CDP على <code>localhost:9222</code> يتيح للمتصفح المدمج عرض كل إجراء في الوقت الفعلي. بدون أي إعداد.',
    ...
    "f8.name": "قابل للبرمجة", "f8.desc": 'CLI وواجهة أنابيب مسماة (<code>\\\\.\\pipe\\pandamux</code>) للأتمتة. بروتوكول JSON-RPC v2 متوافق مع cmux.',
    ...
    "faq1.q": "ما العلاقة بين PandaMUX Everywhere و cmux؟", "faq1.a": 'PandaMUX Everywhere هو فرع Windows من <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux تطبيق macOS أصلي. PandaMUX Everywhere يعيد إنتاج نفس التجربة على Windows.',
    ...
    "faq3.q": "ما الوكلاء المتوافقون؟", "faq3.a": "PandaMUX Everywhere مُحسَّن لـ Claude Code. يمكن استخدام أي وكيل سطر أوامر — Codex، Gemini CLI، Aider، OpenCode أو أي برنامج نصي.",
    ...
    "faq5.q": "كيف يختلف عن Windows Terminal؟", "faq5.a": "PandaMUX Everywhere مصمم خصيصًا لمراقبة وكلاء الذكاء الاصطناعي مع إشعارات ومتصفح مدمج وبيانات وصفية حية.",
    "faq6.q": "هل هو مجاني؟", "faq6.a": 'نعم. PandaMUX Everywhere مفتوح المصدر تحت رخصة MIT. تحميل مجاني من <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
    ...
    "footer.legal": "قانوني", "footer.license": "رخصة MIT", "footer.social": "التواصل", "footer.copyright": "© 2026 PandaMUX Everywhere", "footer.fork": "فرع Windows من", "plugin.badge": "إضافة Claude Code", "plugin.desc": "شغّل عدة وكلاء Claude Code بالتوازي بأمر واحد. تحلل الإضافة قاعدة الشيفرة وتقسّم المهمة إلى مهام فرعية مستقلة وتوزعها على موجات مع إدارة التبعيات ومناطق ملفات معزولة ومراجعة تلقائية في نهاية كل دورة.", "plugin.install_label": "التثبيت", "plugin.view_github": "عرض على GitHub", "plugin.docs": "التوثيق",
  },
  ...
  zh: {
    ...
    "features.title": "功能特性",
    "f1.name": "Claude Code 被动集成", "f1.desc": 'PandaMUX Everywhere 在不改变 Claude Code 行为的情况下进行观察。<code>localhost:9222</code> 上的 CDP 代理让内置浏览器实时显示每个操作。零配置。',
    ...
    "f8.name": "可脚本化", "f8.desc": 'CLI 和命名管道 API（<code>\\\\.\\pipe\\pandamux</code>）用于自动化和脚本。兼容 cmux 的 JSON-RPC v2 协议。',
    ...
    "faq.title": "常见问题",
    "faq1.q": "PandaMUX Everywhere 和 cmux 是什么关系？", "faq1.a": 'PandaMUX Everywhere 是 <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> 的 Windows 分支。cmux 是原生 macOS 应用。PandaMUX Everywhere 使用 Electron + xterm.js + ConPTY 在 Windows 上重现相同体验。',
    "faq2.q": "支持哪些平台？", "faq2.a": '仅 Windows 10 和 11（x64）。macOS 请使用 <a href="https://cmux.com" target="_blank" rel="noopener">cmux</a>。',
    "faq3.q": "哪些代理兼容？", "faq3.a": "PandaMUX Everywhere 针对 Claude Code 进行了优化。任何命令行代理都可使用 — Codex、Gemini CLI、Aider、OpenCode 或任何脚本。",
    "faq4.q": "通知如何工作？", "faq4.a": 'Shell 集成脚本检测命令完成或中断。支持 OSC 9/99/777、CLI <code>pandamux notify</code> 和空闲检测。',
    "faq5.q": "与 Windows Terminal 有何不同？", "faq5.a": "PandaMUX Everywhere 专为监督 AI 代理而设计，具有通知系统、内置浏览器和实时元数据。",
    "faq6.q": "免费吗？", "faq6.a": '是的。PandaMUX Everywhere 是 MIT 许可的开源项目。在 <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a> 免费下载。',
  ...
  "zh-TW": {
    ...
    "features.title": "功能特性",
    "f1.name": "Claude Code 被動整合", "f1.desc": 'PandaMUX Everywhere 在不改變 Claude Code 行為的情況下進行觀察。<code>localhost:9222</code> 上的 CDP 代理讓內建瀏覽器即時顯示每個操作。',
    ...
    "f8.name": "可腳本化", "f8.desc": 'CLI 和命名管道 API（<code>\\\\.\\pipe\\pandamux</code>）用於自動化。',
    ...
    "faq.title": "常見問題",
    "faq1.q": "PandaMUX Everywhere 和 cmux 是什麼關係？", "faq1.a": 'PandaMUX Everywhere 是 <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> 的 Windows 分支。',
    "faq2.q": "支援哪些平台？", "faq2.a": '僅 Windows 10 和 11（x64）。macOS 請使用 <a href="https://cmux.com" target="_blank" rel="noopener">cmux</a>。',
    "faq3.q": "哪些代理相容？", "faq3.a": "PandaMUX Everywhere 針對 Claude Code 進行了最佳化。任何命令列代理皆可使用。",
    "faq4.q": "通知如何運作？", "faq4.a": 'Shell 整合腳本偵測命令完成或中斷。支援 OSC 9/99/777 和 <code>pandamux notify</code>。',
    "faq5.q": "與 Windows Terminal 有何不同？", "faq5.a": "PandaMUX Everywhere 專為監督 AI 代理而設計。",
    "faq6.q": "免費嗎？", "faq6.a": '是的。PandaMUX Everywhere 是 MIT 授權的開源專案。<a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>。',
  ...
  ja: {
    ...
    "features.title": "機能",
    "f1.name": "Claude Codeパッシブ統合", "f1.desc": 'PandaMUX EverywhereはClaude Codeの動作を変更せずに監視します。<code>localhost:9222</code>のCDPプロキシにより、内蔵ブラウザがすべての操作をリアルタイムで表示。設定不要。',
    ...
    "f8.name": "スクリプト可能", "f8.desc": 'CLIと名前付きパイプAPI（<code>\\\\.\\pipe\\pandamux</code>）で自動化。cmux互換のJSON-RPC v2プロトコル。',
    ...
    "faq.title": "よくある質問",
    "faq1.q": "PandaMUX Everywhereとcmuxの関係は？", "faq1.a": 'PandaMUX Everywhereは<a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>のWindowsフォークです。cmuxはネイティブmacOSアプリです。',
    "faq2.q": "対応プラットフォームは？", "faq2.a": 'Windows 10と11のみ（x64）。macOSには<a href="https://cmux.com" target="_blank" rel="noopener">cmux</a>をお使いください。',
    "faq3.q": "互換性のあるエージェントは？", "faq3.a": "PandaMUX EverywhereはClaude Code向けに最適化。任意のコマンドラインエージェントが使用可能です。",
    "faq4.q": "通知はどう機能しますか？", "faq4.a": 'シェル統合スクリプトがコマンドの完了や中断を検出。OSC 9/99/777、<code>pandamux notify</code> CLIに対応。',
    "faq5.q": "Windows Terminalとの違いは？", "faq5.a": "PandaMUX EverywhereはAIエージェントの監視に特化しており、通知システム、内蔵ブラウザ、リアルタイムメタデータを備えています。",
    "faq6.q": "無料ですか？", "faq6.a": 'はい。PandaMUX EverywhereはMITライセンスのオープンソースです。<a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>から無料ダウンロード。',
  ...
  ko: {
    ...
    "features.title": "기능",
    "f1.name": "Claude Code 패시브 통합", "f1.desc": 'PandaMUX Everywhere는 Claude Code의 동작을 변경하지 않고 관찰합니다. <code>localhost:9222</code>의 CDP 프록시가 내장 브라우저에서 모든 작업을 실시간으로 표시합니다.',
    ...
    "f8.name": "스크립팅 가능", "f8.desc": 'CLI 및 명명된 파이프 API (<code>\\\\.\\pipe\\pandamux</code>)로 자동화. cmux 호환 JSON-RPC v2 프로토콜.',
    ...
    "faq.title": "자주 묻는 질문",
    "faq1.q": "PandaMUX Everywhere와 cmux의 관계는?", "faq1.a": 'PandaMUX Everywhere는 <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>의 Windows 포크입니다.',
    "faq2.q": "지원되는 플랫폼은?", "faq2.a": 'Windows 10 및 11만 (x64). macOS는 <a href="https://cmux.com" target="_blank" rel="noopener">cmux</a>를 사용하세요.',
    "faq3.q": "호환되는 에이전트는?", "faq3.a": "PandaMUX Everywhere는 Claude Code에 최적화되어 있습니다. 모든 명령줄 에이전트를 사용할 수 있습니다.",
    "faq4.q": "알림은 어떻게 작동하나요?", "faq4.a": '쉘 통합 스크립트가 명령 완료 또는 중단을 감지합니다. OSC 9/99/777 및 <code>pandamux notify</code> 지원.',
    "faq5.q": "Windows Terminal과의 차이점은?", "faq5.a": "PandaMUX Everywhere는 알림 시스템, 내장 브라우저 및 실시간 메타데이터를 갖춘 AI 에이전트 감독용으로 설계되었습니다.",
    "faq6.q": "무료인가요?", "faq6.a": '네. PandaMUX Everywhere는 MIT 라이선스의 오픈소스입니다. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>에서 무료 다운로드.',
    ...
    "footer.legal": "법적 정보", "footer.license": "MIT 라이선스", "footer.social": "소셜", "footer.copyright": "© 2026 PandaMUX Everywhere", "footer.fork": "Windows 포크 원본:", "plugin.badge": "Claude Code 플러그인", "plugin.desc": "하나의 명령으로 여러 Claude Code 에이전트를 병렬 실행합니다. 플러그인이 코드베이스를 분석하고 작업을 독립적인 하위 작업으로 분할한 뒤 의존성 관리, 격리된 파일 영역, 매 사이클 종료 시 자동 리뷰를 갖춘 웨이브로 배분합니다.", "plugin.install_label": "설치", "plugin.view_github": "GitHub에서 보기", "plugin.docs": "문서",
  },
  ...
  hi: {
    ...
    "f1.name": "निष्क्रिय Claude Code एकीकरण", "f1.desc": 'PandaMUX Everywhere बिना व्यवहार बदले Claude Code को देखता है। <code>localhost:9222</code> पर CDP प्रॉक्सी हर क्रिया को रियल-टाइम में दिखाता है।',
    ...
    "f8.name": "स्क्रिप्टेबल", "f8.desc": 'CLI और नामित पाइप API (<code>\\\\.\\pipe\\pandamux</code>) ऑटोमेशन के लिए।',
    ...
    "faq1.q": "PandaMUX Everywhere और cmux के बीच क्या संबंध है?", "faq1.a": 'PandaMUX Everywhere, <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> का Windows फ़ॉर्क है।',
    ...
    "faq3.q": "कौन से एजेंट संगत हैं?", "faq3.a": "PandaMUX Everywhere Claude Code के लिए अनुकूलित है। कोई भी कमांड-लाइन एजेंट उपयोग किया जा सकता है।",
    ...
    "faq5.q": "Windows Terminal से कैसे अलग है?", "faq5.a": "PandaMUX Everywhere विशेष रूप से AI एजेंटों की निगरानी के लिए डिज़ाइन किया गया है।",
    "faq6.q": "क्या यह मुफ्त है?", "faq6.a": 'हाँ। PandaMUX Everywhere MIT लाइसेंस के तहत ओपन-सोर्स है। <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a> से मुफ्त डाउनलोड करें।',
  ...
  vi: {
    ...
    "f1.name": "Tích hợp thụ động Claude Code", "f1.desc": 'PandaMUX Everywhere quan sát Claude Code mà không thay đổi hành vi. CDP proxy trên <code>localhost:9222</code> cho trình duyệt tích hợp hiển thị mọi hành động theo thời gian thực.',
    ...
    "f8.name": "Có thể lập trình", "f8.desc": 'CLI và API named pipe (<code>\\\\.\\pipe\\pandamux</code>) để tự động hóa.',
    ...
    "faq1.q": "Mối quan hệ giữa PandaMUX Everywhere và cmux?", "faq1.a": 'PandaMUX Everywhere là fork Windows của <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>.',
    ...
    "faq3.q": "Agent nào tương thích?", "faq3.a": "PandaMUX Everywhere được tối ưu cho Claude Code. Bất kỳ agent dòng lệnh nào đều có thể sử dụng.",
    ...
    "faq5.q": "Khác gì với Windows Terminal?", "faq5.a": "PandaMUX Everywhere được thiết kế đặc biệt để giám sát AI agent.",
    "faq6.q": "Miễn phí không?", "faq6.a": 'Có. PandaMUX Everywhere là mã nguồn mở theo giấy phép MIT. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
    ...
    "footer.legal": "Pháp lý", "footer.license": "Giấy phép MIT", "footer.social": "Mạng xã hội", "footer.copyright": "© 2026 PandaMUX Everywhere", "footer.fork": "Fork Windows của", "plugin.badge": "Plugin Claude Code", "plugin.desc": "Chạy nhiều agent Claude Code song song chỉ với một lệnh. Plugin phân tích mã nguồn, chia tác vụ thành các tác vụ con độc lập và phân phối chúng theo đợt với quản lý phụ thuộc, vùng tệp cô lập và đánh giá tự động cuối mỗi chu kỳ.", "plugin.install_label": "Cài đặt", "plugin.view_github": "Xem trên GitHub", "plugin.docs": "Tài liệu",
  },
  ...
  th: {
    ...
    "f1.name": "การรวม Claude Code แบบพาสซีฟ", "f1.desc": 'PandaMUX Everywhere สังเกต Claude Code โดยไม่เปลี่ยนแปลงพฤติกรรม CDP proxy บน <code>localhost:9222</code> แสดงทุกการกระทำแบบเรียลไทม์',
    ...
    "f8.name": "เขียนสคริปต์ได้", "f8.desc": 'CLI และ API named pipe (<code>\\\\.\\pipe\\pandamux</code>) สำหรับอัตโนมัติ',
    ...
    "faq1.q": "PandaMUX Everywhere และ cmux เกี่ยวข้องกันอย่างไร?", "faq1.a": 'PandaMUX Everywhere เป็น fork Windows ของ <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>',
    ...
    "faq3.q": "agent ใดที่เข้ากันได้?", "faq3.a": "PandaMUX Everywhere ปรับให้เหมาะสมสำหรับ Claude Code agent บรรทัดคำสั่งใดก็ได้สามารถใช้ได้",
    ...
    "faq5.q": "แตกต่างจาก Windows Terminal อย่างไร?", "faq5.a": "PandaMUX Everywhere ออกแบบมาเพื่อดูแล AI agent โดยเฉพาะ",
    "faq6.q": "ฟรีหรือไม่?", "faq6.a": 'ใช่ PandaMUX Everywhere เป็นโอเพนซอร์สภายใต้ MIT <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>',
  ...
  id: {
    ...
    "f1.name": "Integrasi pasif Claude Code", "f1.desc": 'PandaMUX Everywhere mengamati Claude Code tanpa mengubah perilakunya. CDP proxy di <code>localhost:9222</code> menampilkan setiap aksi secara real-time.',
    ...
    "f8.name": "Dapat diprogram", "f8.desc": 'CLI dan API named pipe (<code>\\\\.\\pipe\\pandamux</code>) untuk otomatisasi.',
    ...
    "faq1.q": "Apa hubungan PandaMUX Everywhere dan cmux?", "faq1.a": 'PandaMUX Everywhere adalah fork Windows dari <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>.',
    ...
    "faq3.q": "Agen apa yang kompatibel?", "faq3.a": "PandaMUX Everywhere dioptimalkan untuk Claude Code. Agen baris perintah apa pun bisa digunakan.",
    ...
    "faq5.q": "Apa bedanya dengan Windows Terminal?", "faq5.a": "PandaMUX Everywhere dirancang khusus untuk mengawasi agen AI.",
    "faq6.q": "Gratis?", "faq6.a": 'Ya. PandaMUX Everywhere adalah open-source di bawah lisensi MIT. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  sv: {
    ...
    "f1.name": "Passiv Claude Code-integration", "f1.desc": 'PandaMUX Everywhere observerar Claude Code utan att ändra dess beteende. En CDP-proxy på <code>localhost:9222</code> visar varje åtgärd i realtid.',
    ...
    "f8.name": "Skriptbar", "f8.desc": 'CLI och named pipe API (<code>\\\\.\\pipe\\pandamux</code>) för automatisering.',
    ...
    "faq1.q": "Vad är förhållandet mellan PandaMUX Everywhere och cmux?", "faq1.a": 'PandaMUX Everywhere är en Windows-fork av <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>.',
    ...
    "faq3.q": "Vilka agenter är kompatibla?", "faq3.a": "PandaMUX Everywhere är optimerad för Claude Code. Alla kommandoradsagenter kan användas.",
    ...
    "faq5.q": "Hur skiljer det sig från Windows Terminal?", "faq5.a": "PandaMUX Everywhere är specifikt designad för att övervaka AI-agenter.",
    "faq6.q": "Är det gratis?", "faq6.a": 'Ja. PandaMUX Everywhere är öppen källkod under MIT. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
  ...
  cs: {
    ...
    "f1.name": "Pasivní integrace Claude Code", "f1.desc": 'PandaMUX Everywhere pozoruje Claude Code bez změny jeho chování. CDP proxy na <code>localhost:9222</code> zobrazuje každou akci v reálném čase.',
    ...
    "f8.name": "Skriptovatelný", "f8.desc": 'CLI a named pipe API (<code>\\\\.\\pipe\\pandamux</code>) pro automatizaci.',
    ...
    "faq1.q": "Jaký je vztah mezi PandaMUX Everywhere a cmux?", "faq1.a": 'PandaMUX Everywhere je Windows fork projektu <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>.',
    ...
    "faq3.q": "Kteří agenti jsou kompatibilní?", "faq3.a": "PandaMUX Everywhere je optimalizován pro Claude Code. Jakýkoli agent příkazové řádky může být použit.",
    ...
    "faq5.q": "Čím se liší od Windows Terminal?", "faq5.a": "PandaMUX Everywhere je navržen speciálně pro dohled nad AI agenty.",
    "faq6.q": "Je to zdarma?", "faq6.a": 'Ano. PandaMUX Everywhere je open-source pod licencí MIT. <a href="https://github.com/BoardPandas/Pandamux/releases" target="_blank" rel="noopener">GitHub Releases</a>.',
...
function applyLang(lang) {
  ...
  // Update page title
  document.title = `PandaMUX Everywhere — ${strings["hero.tagline"]} Claude Code`;
