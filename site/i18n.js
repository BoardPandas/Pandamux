...
const T = {
  ...
  en: {
    ...
    "f1.desc":
      'PandaMUX observes Claude Code without modifying its behavior. A CDP proxy on <code>localhost:9222</code> lets the built-in browser show every action in real time. Auto-configured hooks report agent and tool activity to the sidebar. Zero configuration.',
    ...
    "faq1.a":
      'PandaMUX is a Windows fork of <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux is a native macOS app (Swift + AppKit + Ghostty). PandaMUX reproduces the same experience on Windows using Electron + xterm.js + ConPTY. The CLI/pipe protocol is compatible between the two.',
    ...
    "faq5.a":
      "Windows Terminal is an excellent terminal emulator, but it has no notification system, no agent activity visibility, no built-in browser, and no live metadata (git branch, ports, PR) in tabs. PandaMUX is specifically designed to supervise AI agents.",
    "faq6.q": "Is it free?",
    "faq6.a":
  ...
  fr: {
    ...
    "f1.desc":
      'PandaMUX observe Claude Code sans modifier son comportement. Un proxy CDP sur <code>localhost:9222</code> permet au navigateur intégré de montrer chaque action en temps réel. Les hooks auto-configurés rapportent l\'activité des agents et outils dans la barre latérale. Zéro configuration.',
    ...
    "faq5.a":
      "Windows Terminal est un excellent émulateur de terminal, mais il n'a pas de système de notification, pas de visibilité sur l'activité des agents, pas de navigateur intégré, et pas de métadonnées live (branche git, ports, PR) dans les onglets. PandaMUX est conçu spécifiquement pour superviser des agents IA.",
  ...
  es: {
    ...
    "f1.desc":
      'PandaMUX observa Claude Code sin modificar su comportamiento. Un proxy CDP en <code>localhost:9222</code> permite al navegador integrado mostrar cada acción en tiempo real. Los hooks autoconfigurados reportan la actividad de agentes y herramientas en la barra lateral. Cero configuración.',
    ...
    "faq1.a":
      'PandaMUX es un fork de Windows de <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux es una app nativa de macOS (Swift + AppKit + Ghostty). PandaMUX reproduce la misma experiencia en Windows usando Electron + xterm.js + ConPTY. El protocolo CLI/pipe es compatible entre ambos.',
    ...
    "faq5.a":
      "Windows Terminal es un excelente emulador de terminal, pero no tiene sistema de notificaciones, ni visibilidad de actividad de agentes, ni navegador integrado, ni metadatos en vivo (rama git, puertos, PR) en las pestañas. PandaMUX está diseñado específicamente para supervisar agentes IA.",
    "faq6.q": "¿Es gratis?",
    "faq6.a":
  ...
  de: {
    ...
    "f1.name": "Passive Claude Code Integration",
    "f1.desc":
      'PandaMUX beobachtet Claude Code ohne sein Verhalten zu ändern. Ein CDP-Proxy auf <code>localhost:9222</code> lässt den integrierten Browser jede Aktion in Echtzeit anzeigen. Automatisch konfigurierte Hooks melden Agenten- und Tool-Aktivität in der Seitenleiste. Null Konfiguration.',
    ...
    "faq5.a":
      "Windows Terminal ist ein hervorragender Terminal-Emulator, hat aber kein Benachrichtigungssystem, keine Agenten-Aktivitätssichtbarkeit, keinen integrierten Browser und keine Live-Metadaten (Git-Branch, Ports, PR) in den Tabs. PandaMUX ist speziell für die Überwachung von KI-Agenten konzipiert.",
  ...
  pt: {
    ...
    "f1.desc": 'PandaMUX observa o Claude Code sem modificar seu comportamento. Um proxy CDP em <code>localhost:9222</code> permite ao navegador integrado mostrar cada ação em tempo real. Hooks autoconfigurados reportam atividade de agentes e ferramentas na barra lateral. Zero configuração.',
    "f2.name": "Navegador integrado",
    ...
    "faq1.a": 'PandaMUX é um fork Windows de <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux é um app nativo macOS (Swift + AppKit + Ghostty). PandaMUX reproduz a mesma experiência no Windows usando Electron + xterm.js + ConPTY. O protocolo CLI/pipe é compatível entre os dois.',
    ...
    "faq5.a": "Windows Terminal é um excelente emulador de terminal, mas não tem sistema de notificações, visibilidade de atividade de agentes, navegador integrado ou metadados em tempo real (branch git, portas, PR) nas abas. PandaMUX é projetado especificamente para supervisionar agentes IA.",
    "faq6.q": "É grátis?",
  ...
  it: {
    ...
    "f1.desc": 'PandaMUX osserva Claude Code senza modificare il suo comportamento. Un proxy CDP su <code>localhost:9222</code> permette al browser integrato di mostrare ogni azione in tempo reale. Gli hook autoconfigurati riportano l\'attività di agenti e strumenti nella barra laterale. Zero configurazione.',
    ...
    "faq1.a": 'PandaMUX è un fork Windows di <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux è un\'app nativa macOS (Swift + AppKit + Ghostty). PandaMUX riproduce la stessa esperienza su Windows usando Electron + xterm.js + ConPTY. Il protocollo CLI/pipe è compatibile tra i due.',
    ...
    "faq5.a": "Windows Terminal è un eccellente emulatore di terminale, ma non ha un sistema di notifiche, visibilità sull'attività degli agenti, browser integrato o metadati live (branch git, porte, PR) nei tab. PandaMUX è progettato specificamente per supervisionare agenti IA.",
    "faq6.q": "È gratuito?",
  ...
  nl: {
    ...
    "f1.name": "Passieve Claude Code integratie", "f1.desc": 'PandaMUX observeert Claude Code zonder het gedrag te wijzigen. Een CDP-proxy op <code>localhost:9222</code> laat de ingebouwde browser elke actie in realtime tonen. Automatisch geconfigureerde hooks rapporteren agent- en tool-activiteit in de zijbalk. Nul configuratie.',
    ...
    "faq1.q": "Wat is de relatie tussen PandaMUX en cmux?", "faq1.a": 'PandaMUX is een Windows-fork van <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>. cmux is een native macOS-app (Swift + AppKit + Ghostty). PandaMUX reproduceert dezelfde ervaring op Windows met Electron + xterm.js + ConPTY.',
    ...
    "faq5.q": "Hoe verschilt het van Windows Terminal?", "faq5.a": "Windows Terminal heeft geen meldingssysteem, geen agentactiviteitsweergave, geen ingebouwde browser en geen live-metadata in tabbladen. PandaMUX is specifiek ontworpen voor het toezicht op AI-agenten.",
  ...
  pl: {
    ...
    "f1.name": "Pasywna integracja z Claude Code", "f1.desc": 'PandaMUX obserwuje Claude Code bez modyfikowania jego zachowania. Proxy CDP na <code>localhost:9222</code> pozwala wbudowanej przeglądarce pokazywać każdą akcję w czasie rzeczywistym. Zero konfiguracji.',
    ...
    "faq5.q": "Czym się różni od Windows Terminal?", "faq5.a": "Windows Terminal nie ma systemu powiadomień, widoczności agentów, wbudowanej przeglądarki ani metadanych na żywo. PandaMUX jest zaprojektowany do nadzorowania agentów AI.",
  ...
  tr: {
    ...
    "f1.name": "Pasif Claude Code entegrasyonu", "f1.desc": 'PandaMUX, Claude Code\'u davranışını değiştirmeden gözlemler. <code>localhost:9222</code> üzerindeki CDP proxy\'si her eylemi gerçek zamanlı gösterir. Sıfır yapılandırma.',
    ...
    "faq1.q": "PandaMUX ve cmux arasındaki ilişki nedir?", "faq1.a": 'PandaMUX, <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a>\'un Windows fork\'udur. cmux yerel macOS uygulamasıdır. PandaMUX aynı deneyimi Windows\'ta Electron + xterm.js + ConPTY kullanarak yeniden üretir.',
    ...
    "faq5.q": "Windows Terminal'den farkı nedir?", "faq5.a": "Windows Terminal\'de bildirim sistemi, ajan aktivite görünürlüğü, yerleşik tarayıcı ve canlı metadata yoktur. PandaMUX özellikle AI ajanlarını denetlemek için tasarlanmıştır.",
  ...
  ru: {
    ...
    "f1.name": "Пассивная интеграция с Claude Code", "f1.desc": 'PandaMUX наблюдает за Claude Code не изменяя его поведение. CDP-прокси на <code>localhost:9222</code> позволяет встроенному браузеру показывать каждое действие в реальном времени. Нулевая настройка.',
    ...
    "faq1.q": "Какая связь между PandaMUX и cmux?", "faq1.a": 'PandaMUX — это форк <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> для Windows. cmux — нативное приложение macOS. PandaMUX воспроизводит тот же опыт на Windows используя Electron + xterm.js + ConPTY.',
    ...
    "faq5.q": "Чем отличается от Windows Terminal?", "faq5.a": "Windows Terminal не имеет системы уведомлений, видимости активности агентов, встроенного браузера и метаданных в реальном времени. PandaMUX разработан специально для наблюдения за ИИ-агентами.",
  ...
  uk: {
    ...
    "f1.name": "Пасивна інтеграція з Claude Code", "f1.desc": 'PandaMUX спостерігає за Claude Code не змінюючи його поведінку. CDP-проксі на <code>localhost:9222</code> дозволяє вбудованому браузеру показувати кожну дію в реальному часі.',
    ...
    "faq5.q": "Чим відрізняється від Windows Terminal?", "faq5.a": "PandaMUX розроблений спеціально для спостереження за ШІ-агентами з сповіщеннями та вбудованим браузером.",
  ...
  ar: {
    ...
    "f1.name": "تكامل سلبي مع Claude Code", "f1.desc": 'يراقب PandaMUX Claude Code دون تغيير سلوكه. بروكسي CDP على <code>localhost:9222</code> يتيح للمتصفح المدمج عرض كل إجراء في الوقت الفعلي. بدون أي إعداد.',
    ...
    "faq5.q": "كيف يختلف عن Windows Terminal؟", "faq5.a": "PandaMUX مصمم خصيصًا لمراقبة وكلاء الذكاء الاصطناعي مع إشعارات ومتصفح مدمج وبيانات وصفية حية.",
  ...
  zh: {
    ...
    "features.title": "功能特性",
    "f1.name": "Claude Code 被动集成", "f1.desc": 'PandaMUX 在不改变 Claude Code 行为的情况下进行观察。<code>localhost:9222</code> 上的 CDP 代理让内置浏览器实时显示每个操作。零配置。',
    ...
    "faq.title": "常见问题",
    "faq1.q": "PandaMUX 和 cmux 是什么关系？", "faq1.a": 'PandaMUX 是 <a href="https://github.com/manaflow-ai/cmux" target="_blank" rel="noopener">cmux</a> 的 Windows 分支。cmux 是原生 macOS 应用。PandaMUX 使用 Electron + xterm.js + ConPTY 在 Windows 上重现相同体验。',
    ...
    "faq5.q": "与 Windows Terminal 有何不同？", "faq5.a": "PandaMUX 专为监督 AI 代理而设计，具有通知系统、内置浏览器和实时元数据。",
  ...
  "zh-TW": {
    ...
    "features.title": "功能特性",
    "f1.name": "Claude Code 被動整合", "f1.desc": 'PandaMUX 在不改變 Claude Code 行為的情況下進行觀察。<code>localhost:9222</code> 上的 CDP 代理讓內建瀏覽器即時顯示每個操作。',
  ...
  ja: {
    ...
    "features.title": "機能",
    "f1.name": "Claude Codeパッシブ統合", "f1.desc": 'PandaMUXはClaude Codeの動作を変更せずに監視します。<code>localhost:9222</code>のCDPプロキシにより、内蔵ブラウザがすべての操作をリアルタイムで表示。設定不要。',
    ...
    "faq5.q": "Windows Terminalとの違いは？", "faq5.a": "PandaMUXはAIエージェントの監視に特化しており、通知システム、内蔵ブラウザ、リアルタイムメタデータを備えています。",
  ...
  ko: {
    ...
    "features.title": "기능",
    "f1.name": "Claude Code 패시브 통합", "f1.desc": 'PandaMUX는 Claude Code의 동작을 변경하지 않고 관찰합니다. <code>localhost:9222</code>의 CDP 프록시가 내장 브라우저에서 모든 작업을 실시간으로 표시합니다.',
    ...
    "faq5.q": "Windows Terminal과의 차이점은?", "faq5.a": "PandaMUX는 알림 시스템, 내장 브라우저 및 실시간 메타데이터를 갖춘 AI 에이전트 감독용으로 설계되었습니다.",
  ...
  hi: {
    ...
    "f1.name": "निष्क्रिय Claude Code एकीकरण", "f1.desc": 'PandaMUX बिना व्यवहार बदले Claude Code को देखता है। <code>localhost:9222</code> पर CDP प्रॉक्सी हर क्रिया को रियल-टाइम में दिखाता है।',
  ...
  vi: {
    ...
    "f1.name": "Tích hợp thụ động Claude Code", "f1.desc": 'PandaMUX quan sát Claude Code mà không thay đổi hành vi. CDP proxy trên <code>localhost:9222</code> cho trình duyệt tích hợp hiển thị mọi hành động theo thời gian thực.',
  ...
  th: {
    ...
    "f1.name": "การรวม Claude Code แบบพาสซีฟ", "f1.desc": 'PandaMUX สังเกต Claude Code โดยไม่เปลี่ยนแปลงพฤติกรรม CDP proxy บน <code>localhost:9222</code> แสดงทุกการกระทำแบบเรียลไทม์',
  ...
  id: {
    ...
    "f1.name": "Integrasi pasif Claude Code", "f1.desc": 'PandaMUX mengamati Claude Code tanpa mengubah perilakunya. CDP proxy di <code>localhost:9222</code> menampilkan setiap aksi secara real-time.',
  ...
  sv: {
    ...
    "f1.name": "Passiv Claude Code-integration", "f1.desc": 'PandaMUX observerar Claude Code utan att ändra dess beteende. En CDP-proxy på <code>localhost:9222</code> visar varje åtgärd i realtid.',
  ...
  cs: {
    ...
    "f1.name": "Pasivní integrace Claude Code", "f1.desc": 'PandaMUX pozoruje Claude Code bez změny jeho chování. CDP proxy na <code>localhost:9222</code> zobrazuje každou akci v reálném čase.',
