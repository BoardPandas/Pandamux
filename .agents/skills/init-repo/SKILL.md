...
4. Include relevant gotchas as warnings in the generated AGENTS.md or agent-memory/debugging.md.
...
- **AGENTS.md:** Build a hierarchical AGENTS.md structure:
  ...
  - Include in the Planning section: "Every plan MUST end with a Learning Lessons / Gotchas section. After implementation, route discoveries to `.Codex/agent-memory/debugging.md`."
